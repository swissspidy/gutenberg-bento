...
function register_carousel_block_assets() {
	...
	wp_register_style( BLOCK_VIEW_STYLE_HANDLE, plugins_url( basename( dirname( __DIR__ ) ) ) . '/build/carousel.view.css', array( Extension::BASE_CAROUSEL ), $view_asset['version'] );
